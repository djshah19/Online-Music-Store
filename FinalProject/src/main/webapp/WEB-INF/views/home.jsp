        ...
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p>Here you can browse and buy Instruments, Records and music related Accessories. Order Now for Your 
              Amazing New Kit!</p>
        ...
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p>Music brings joy, to all of out hearts. It's one of those, emotional arts.</p>
            </div>
          </div>
        </div>
        <div class="item">
