...
//		if(captcha.validate(captchaCode)) {
			...
			try {
				...
				try {
					String str = "http://localhost:8080/web/user/validateemail.htm?email="+useremail + "&key1="
...
//		}
	...
	public String resendEmail(HttpServletRequest request) {
		...
		int randomNum2 = rand.nextInt(5000000);
		try {
			String str = "http://localhost:8080/web/user/validateemail.htm?email=" + useremail + "&key1=" + randomNum1
					+ "&key2=" + randomNum2;
			session.setAttribute("key1", randomNum1);
			session.setAttribute("key2", randomNum2);
			sendEmail(useremail,
